...
10. Execute with: $ python3.7 release_readiness_criteria.py <SPREADSHEET NAME>
...
$ python3.7 tracking_dashboard.py <SPREADSHEET NAME>
...
### Usage:
Same steps as above with changing the script you execute in step 8 to:
$ python3.7 arrivals_vs_resolved.py <SPREADSHEET NAME>
